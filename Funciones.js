...
(function (SegundoParcial) {
    ...
    var divInfo;
    var btnCancelar;
    var auto1 = new SegundoParcial.Auto(1, "Toyota", "Yaris", 3000000, 4);
    var camioneta1 = new SegundoParcial.Camioneta(2, "Toyota", "Hylux", 25000000, true);
    ...
    function filtrar() {
        ...
        var vehiculosFiltrados = vehicleList.filter(function (registro) {
    ...
    function actualizarTabla(vehiculosFiltrados) {
        vehiculosFiltrados.forEach(function (registro) {
    ...
    function consultarFormExistente() {
        for (var _i = 0, _a = document.body.children; _i < _a.length; _i++) {
            hijos = _a[_i];
